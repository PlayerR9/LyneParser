...
// HelperNodeIterator is a pull-based iterator that iterates
// over the children of a HelperNode.
type HelperNodeIterator[T gr.TokenTyper] struct {
	parent, current *HelperNode[T]
}
...
func (tn *HelperNode[T]) String() string {
	...
	builder.WriteString(" (")
	builder.WriteString(tn.Action.String())
	builder.WriteRune(')')
...
func (tn *HelperNode[T]) Copy() common.Copier {
	...
	tn_copy := &HelperNode[T]{
		Item:   tn.Item.Copy().(*Item[T]),
		Action: tn.Action.Copy().(HelperElem[T]),
	}
...
func (tn *HelperNode[T]) LinkChildren(children []treenode.Noder) {
	...
	var valid_children []*HelperNode[T]
...
// same as the behaviors of the HelperNode.AddChild function.
//
// Parameters:
...
// Returns:
//   - []treenode.Noder: A slice of pointers to the children of the node.
func (tn *HelperNode[T]) delete_child(target *HelperNode[T]) []treenode.Noder {
